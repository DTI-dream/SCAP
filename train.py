...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='Summary_forget_model')
    ...
    parser.add_argument('--features_path', type=str, default=r"D:\multimodel\data\features\coco_detections.hdf5")
    parser.add_argument('--annotation_folder', type=str, default=r"D:\multimodel\data\annotations")
    parser.add_argument('--logs_folder', type=str, default='tensorboard_logs')
    args = parser.parse_args()
    print(args)

    print('Summary_forget_model Training')
    ...
    # decoder = MeshedDecoder(len(text_field.vocab), 54, 2, text_field.vocab.stoi['<pad>'])
    ...
    # Initial conditions
    optim = AdamW(model.parameters(), lr=0.0001, betas=(0.9, 0.98))
